...
public class ChunkGeneratorSadnut implements IChunkGenerator {
 ...
 private TerrainGeneratorSadnut terraingen = new TerrainGeneratorSadnut();

 public ChunkGeneratorSadnut(World worldObj) {
