...
public class PlanksBase extends BlockBase {
	...
	public PlanksBase() {
		...
		ItemBlock item = new ItemBlock(this) {
			...
			public String getUnlocalizedName(ItemStack stack) {
				IBlockState state = PlanksBase.this.getStateFromMeta(stack.getMetadata());
				return getUnlocalizedName() + "_" + state.getValue(PlanksBase.VARIANT);
			}
	...
	public int damageDropped(IBlockState state) {
		return ((PlanksBase.EnumType) state.getValue(VARIANT)).getMetadata();
	}
	...
	public static enum EnumType implements IStringSerializable {
		...
		static {
			for (PlanksBase.EnumType blockplanks$enumtype : values()) {
